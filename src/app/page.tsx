...
export const metadata: Metadata = {
  title: "Bhagat Singh",
  description: "Hi! Welcome to my corner of the internet! I'm Bhagat singh. I craft seamless digital experiences by blending data-driven insights with creative design.",
  openGraph: {
    title: "Portfolio of Bhagat Singh"
  }
};
...
export default function Home() {
  return (  
    <main className="ml-[5vw] md:ml-[15vw] z-50">
      <div className="mt-[10vh] md:mt-[5vh] text-3xl tracking-tight opacity-80"> I'm Bhagat Singh. How are you?</div>
